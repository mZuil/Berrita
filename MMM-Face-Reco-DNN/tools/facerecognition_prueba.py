...
# Path of face detection, age detection and gender detection
#faceProto = "/home/pi/MagicMirror/modules/MMM-Face-Reco-DNN/tools/opencv_face_detector.pbtxt"
#faceModel = "/home/pi/MagicMirror/modules/MMM-Face-Reco-DNN/tools/opencv_face_detector_uint8.pb"

ageProto = "/home/pi/MagicMirror/modules/MMM-Face-Reco-DNN/tools/metadata-detection/age_deploy.prototxt"
ageModel = "/home/pi/MagicMirror/modules/MMM-Face-Reco-DNN/tools/metadata-detection/age_net.caffemodel"

genderProto = "/home/pi/MagicMirror/modules/MMM-Face-Reco-DNN/tools/metadata-detection/gender_deploy.prototxt"
genderModel = "/home/pi/MagicMirror/modules/MMM-Face-Reco-DNN/tools/metadata-detection/gender_net.caffemodel"

# Available values to be predicted
...
def detect_and_predict_age_and_gender(frame, box, ageNet, genderNet):
    #Box = (top = endY (0), right = endX (1), bottom = startY (2), left = startX(3))
    face = frame[box[2]:box[0], box[3]:box[1]]
...
while True:
    ...
    results = []
    for box in boxes:
        results.append(detect_and_predict_age_and_gender(frame, box, ageNet, genderNet))
    ...
    for index, n in enumerate(names):
        if (prevNames.__contains__(n) == False and n is not None):
            logins.append(n)
            agesSelected.append(ages[index])
            gendersSelected.append(genders[index])
    ...
    for index, n in enumerate(prevNames):
