...
faceProto = "/home/pi/MagicMirror/modules/MMM-Face-Reco-DNN/tools/metadata-detection/opencv_face_detector.pbtxt"
faceModel = "/home/pi/MagicMirror/modules/MMM-Face-Reco-DNN/tools/metadata-detection/opencv_face_detector_uint8.pb"
...
def detect_and_predict_age_and_gender(frame, faceNet, ageNet, genderNet, minConf=0.5):
		results = []
		#Get age and gender:
		(h,w) = frame.shape[:2]
...
while True:
	...
	results = detect_and_predict_age_and_gender(frame, faceNet, ageNet, genderNet, minConf=0.5)
	for r in results:
		ages.append(r["age"][0])
