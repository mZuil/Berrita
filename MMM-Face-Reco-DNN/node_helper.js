    ...
    self.pyshell.on('message', function(message) {
      ...
      if (message.hasOwnProperty('login')) {
        console.log(
          '[' +
            ...
            ' logged in. Ages: ' + message.login.ages.join(' - ')+
            '. Genders: ' + message.login.genders.join(' - ')
        );
        self.sendSocketNotification('user', {
          action: 'login',
          users: message.login.names,
          ages: message.login.ages,
          genders: message.login.genders
        });
      }
      ...
      if (message.hasOwnProperty('logout')) {
        ...
        self.sendSocketNotification('user', {
          ...
          ages: message.logout.ages,
          genders: message.logout.genders,
        });
      }
    });
